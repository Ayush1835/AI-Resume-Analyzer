...
async def analyze_resume(
    ...
    generate_pdf_report(
        ...
        applicant_name=resume.extracted_json.get("contact", {}).get("name", current_user.full_name or "Applicant"),
        contact_info=resume.extracted_json.get("contact", {}),
        scores=scores_dict,
        suggestions=new_analysis.suggestions_json,
        ai_feedback=new_analysis.ai_feedback_json
    )
    
    # 8. Save Report details in DB
    new_report = Report(
